...
| -p           | --read-type      | Specify the type of reads to calculating the warting length for alignment skeleton. *1* For reads with high error rates ~15%. *2* For reads with low error rates ~1%. | 1 |
